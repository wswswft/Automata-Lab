...
export function parseAutomataJson(jsonString, alertData) {
  ...
  if (
    automataData.automataType === undefined ||
    automataData.version === undefined ||
    automataData.nextStateId === undefined ||
    automataData.nextEdgeId === undefined ||
    automataData.states === undefined ||
    automataData.graphNodes === undefined ||
    automataData.graphEdges === undefined
  ) {
    alertData.showAlertAnimated("文件格式非法");
    return null;
  }
